...
bsize_myinput=int(sys.argv[3])
seed=int(sys.argv[4])
max_epochs=int(sys.argv[5])
ep_maxlr=int(sys.argv[6])
job_id=int(sys.argv[7])
...
filename_template = f"model_FX2DNN_twithreciGIF_Mvlognormal_noinferGIFb_tanh01_{seed}_{job_id}_best{{epoch}}-{{val_loss:.5f}}"
